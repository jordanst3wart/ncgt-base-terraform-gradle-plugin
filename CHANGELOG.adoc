...
== 1.5.3
* Adding -var-file cmd arg to tfDestory task

== 1.2.1
* Remove `--approve` being required for tfDestroy tasks
...
* Bump dependencies
* Drop support for gradle 4, and 5
* Bump to jdk 11
* Bump gradletest to 3

== 1.1.1 - 1.1.2

=== Bugs

* amd64 terraform binary was being used on macOS regardless of the CPU architecture .

== 1.1.0 - 1.1.1

=== Bugs

* {issue}90[#90] Add additional Terrform CLI configuration setting plugin_cache_may_break_dependency_lock_file (false as default) to the TerraformRCextension.
