...
* https://gitlab.com/EvansM4[@EvansM4] and https://gitlab.com/diggeles-newscorp[@diggeles-newscorp] - For fixing the https://gitlab.com/ysb33rOrg/terraform-gradle-plugin/-/issues/90[Terraform caching bug].
