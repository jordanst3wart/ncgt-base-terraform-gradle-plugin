...
<4> Clear all task-level environmental variables (in this example the `terraformInit` task) and replace with a new set. Clearing the environmental variable set will not remove the efault environmental variables. If you need to have them changed, set them explicitly
